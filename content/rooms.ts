...
export const ROOMS: Room[] = [
...

  {
    ...
    look: {
      ...
      theme: "outdoor-warm",
      atmosphere:
        "Gravel crunching under wheels. Someone's already unloading bags before the engine's off. The house is right there — weathered white paint, large garden, terrace visible around the side. The front door has a key box. Whoever holds the code isn't here.",
      backgroundStyle: "outdoor-golden",
      colorFrom: "from-amber-900",
      colorTo: "to-stone-900",
    },
    description:
      "Cars parked. Bags on the gravel. The house is right there. But the front door has a key box with a code — and whoever always holds the key isn't answering their phone. Start exploring while you wait.",
    ...
    da: {
      title: "Indkørslen",
      description: "Biler parkeret. Tasker på grusen. Huset er lige derover. Men hoveddøren har en nøgleboks med en kode — og den der altid har nøglen, svarer ikke sin telefon.",
...

  {
    ...
    questIds: ["terrace-shelf-a", "terrace-shelf-b"],
...

  {
    ...
    unlockCost: 0,
    unlockRequires: ["garden"],
    questIds: ["petanque-missing-ball"],
    rewardClueIds: [],
    isOptional: true,
    order: 3,
    da: {
...

  {
    ...
    lockedDescription: "The front door. Someone's blocking the way — help them unload first.",
    unlockCost: 0,
    unlockRequires: ["shed"],
    ...
    da: {
      ...
      lockedDescription: "Hoveddøren. Nogen blokerer vejen — hjælp dem med at losse først.",
...

  {
    ...
    questIds: ["sunroom-plants", "sunroom-sunblind"],
...

  {
    ...
    unlockCost: 0,
    unlockRequires: ["kitchen-act2"],
    questIds: ["activity-room-fragment-a", "activity-room-fragment-b"],
...

  {
    ...
    look: {
      ...
      theme: "dark",
      atmosphere:
        "A recess off the dining room you hadn't noticed before. Hooks on the wall. A coat you don't recognise. A basket of things that belong to the house, not to any visitor.",
      backgroundStyle: "dark-utility",
      colorFrom: "from-zinc-950",
      colorTo: "to-stone-950",
    },
    description:
      "A utility corner off the dining room — unlit, barely noticed in Act 2. In the dark it's the first place worth checking.",
    lockedDescription: "A recess in the dark. Investigate the dining room first.",
    unlockCost: 0,
    unlockRequires: ["dining-room-dark"],
    questIds: ["utility-find-flashlight-a", "utility-find-flashlight-b"],
    rewardClueIds: ["artifact-flashlight"],
    isOptional: false,
    order: 2,
    da: {
      title: "Redskabshjørnet",
      description: "Et hjørne ved spisestuen du ikke had bemærket før. Kroge på væggen. Et tørklæde du ikke genkender.",
...

  {
    ...
    questIds: ["corridor-explore", "corridor-door-check-a", "corridor-door-check-b"],
    rewardClueIds: [],
    isOptional: false,
    order: 3,
    da: {
...

  {
    ...
    questIds: ["fusebox-identify-a", "fusebox-identify-b", "fusebox-repair"],
...

  {
    ...
    questIds: ["dark-kitchen-drawer-a", "dark-kitchen-drawer-b"],
...

  {
    ...
    questIds: ["window-fix", "window-rattle-a", "window-rattle-b"],
    rewardClueIds: [],
    isOptional: true,
    order: 6,
    da: {
...

  {
    ...
    unlockCost: 0,
    unlockRequires: ["back-corridor"],
    questIds: ["door-nobody-tried-open", "door-nobody-tried-examine-a", "door-nobody-tried-examine-b"],
    rewardClueIds: [],
    isOptional: false,
    order: 7,
    da: {
...

  {
    ...
    questIds: ["meter-cupboard-switch", "meter-cupboard-candle-hint-a", "meter-cupboard-candle-hint-b"],
...

  {
    ...
    questIds: ["sealed-wall-read", "sealed-wall-understand-a", "sealed-wall-understand-b"],
...

  {
    ...
    unlockCost: 2,
    unlockRequires: ["back-corridor"],
    questIds: ["behind-shed-explore", "behind-shed-dark-a", "behind-shed-dark-b"],
    rewardClueIds: [],
    isOptional: false,
    order: 9,
    da: {
...

  {
    ...
    questIds: ["conservatory-find-candle-a", "conservatory-find-candle-b"],
    ...
    da: {
      ...
      lockedDescription: "Orangeriet. Gå bag skuret først.",
...

  {
    ...
    unlockCost: 0,
    unlockRequires: ["behind-the-shed"],
    questIds: ["shed-dark-note-a", "shed-dark-note-b"],
