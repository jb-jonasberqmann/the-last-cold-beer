    ...
    phases: [
      {
        ...
        actions: [
          ...
          {
            id: "yourselves-whos-missing",
            label: "How many of you, really?",
            description:
              "The Driveway photo, hours ago. Nobody's recounted it since — the number just stuck, unquestioned, all night.",
            type: "puzzle",
            damage: 28,
            puzzle: {
              prompt: "Without checking the Case File or counting out loud in front of the house: how many people are on your team tonight?",
              answer: [],
              dynamicAnswer: { type: "teamSize" },
            },
            hint: "Look around the room. Count yourselves. That's the number.",
            rewardText: "That's the number. Nobody in the group has ever really had to stop and count before. 28 HP.",
            failureText: "Count the people on your team, right now, in this room.",
          },
        ],
      },
      {
