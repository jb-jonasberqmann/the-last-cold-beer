...
export const ROOMS: Room[] = [
...

  {
    ...
    unlockCost: 0,
    unlockRequires: [],
    questIds: ["driveway-arrival", "driveway-mads-call"],
    rewardClueIds: ["fragment-driveway"],
    isOptional: false,
    order: 1,
    da: {
      title: "Indkørslen",
...

  {
    ...
    description:
      "The terrace runs along the front of the house. New wood — bright, unstained. You can see inside through the glass doors but cannot enter. Check the railing. Things get carved into railings when people want them found later.",
    lockedDescription: "The terrace. Explore the driveway first.",
    unlockCost: 0,
    unlockRequires: ["driveway"],
    questIds: ["terrace-railing", "terrace-view"],
    rewardClueIds: ["fragment-terrace"],
    isOptional: false,
    order: 2,
    da: {
      title: "Terrassen",
      description: "Terrassen løber langs forsiden af huset. Nyt træ — lyst, ubehandlet. Du kan se ind gennem glasdørene men kan ikke komme ind. Tjek gelænderet.",
...

  {
    ...
    look: {
      ...
      theme: "outdoor-wild",
      atmosphere:
        "1,250 square metres of fenced coastal garden. Wild grass, a few old fruit trees, the shed at the back. The wind comes off the water. Somewhere in here a fragment is hidden — someone put it in a tree.",
      backgroundStyle: "outdoor-green",
      colorFrom: "from-green-900",
      colorTo: "to-stone-900",
    },
    description:
      "Large fenced garden, natural and breezy. The old oak near the back fence looks like it's been used as a hiding spot more than once. Something is tucked inside the hollow.",
    lockedDescription: "The garden. Finish the driveway first.",
    unlockCost: 0,
    unlockRequires: ["driveway"],
    questIds: ["garden-search", "garden-oak-hollow"],
    rewardClueIds: ["fragment-garden"],
    isOptional: false,
    order: 3,
    da: {
      title: "Haven",
      description: "Stor indhegnet have, naturlig og blæsende. Den gamle egetræ ved baghegnet ser ud til at have været brugt som gemmested mere end én gang.",
...

  {
    ...
    description:
      "The shed hasn't been properly tidied since the house was built. Check behind the door — and look at what's pinned to the wall. Someone has been keeping track of something.",
    ...
    da: {
      title: "Skuret",
      description: "Forvitret udestue bagerst i haven. Kig bag døren — og se hvad der er fastgjort til væggen.",
...

  {
    ...
    look: {
      ...
      theme: "outdoor-warm",
      atmosphere:
        "The key box is mounted to the right of the door. Five digits. The house waits. You have all five fragments now. Enter the code.",
      backgroundStyle: "outdoor-golden",
...

  {
    ...
    look: {
      ...
      theme: "outdoor-warm",
      atmosphere:
        "Mads's car pulls in. He's already got the door open before he's properly parked. Arms full — cooler, sleeping bag, two cases of beer. He grins. He does not apologize for being late.",
      backgroundStyle: "outdoor-golden",
      colorFrom: "from-amber-700",
      colorTo: "to-stone-800",
    },
    description:
      "Mads has arrived. He needs help unloading. Help him get everything inside — and he'll give you the last code fragment.",
    lockedDescription: "The carport. Mads will show up when he shows up.",
    unlockCost: 0,
    unlockRequires: ["terrace", "garden"],
    questIds: [],
    rewardClueIds: ["fragment-mads"],
    isOptional: false,
    order: 7,
    da: {
      title: "Carporten",
      description: "Mads er ankommet. Han har brug for hjælp til at losse. Hjælp ham med at få alt ind — og han giver jer det sidste kodefragment.",
      lockedDescription: "Carporten. Mads dukker op når han dukker op.",
      atmosphere: "Mads' bil kører ind. Han har allerede døren åben inden han er ordenligt parkeret. Armene fulde — køler, sovepose, to kasser øl.",
    },
  },
...

  {
    ...
    unlockCost: 0,
    unlockRequires: [],
    questIds: ["double-room-explore", "double-room-note"],
    rewardClueIds: ["word-owed"],
    isOptional: false,
    order: 1,
    da: {
...

  {
    ...
    unlockCost: 0,
    unlockRequires: [],
    questIds: ["single-room-explore", "single-room-note"],
    rewardClueIds: ["word-borrowed"],
    isOptional: false,
    order: 2,
    da: {
...

  {
    ...
    unlockCost: 0,
    unlockRequires: [],
    questIds: ["bunk-room-explore", "bunk-room-note"],
    rewardClueIds: ["word-taken"],
    isOptional: false,
    order: 3,
    da: {
      title: "Køjestuen",
...

  {
    ...
    questIds: ["living-room-sentence", "living-room-radio"],
...

  {
    ...
    questIds: ["sunroom-plants", "sunroom-wind"],
    rewardClueIds: [],
    isOptional: true,
    order: 5,
    da: {
...

  {
    ...
    look: {
      ...
      theme: "cabin-warm",
      atmosphere:
        "A long pine table, eight chairs. Candles in holders. And on the shelf — the radio. Old brown bakelite, green tuner dial. It has been crackling all evening. Tonight you fix it.",
      backgroundStyle: "warm-dining",
      colorFrom: "from-amber-950",
      colorTo: "to-stone-900",
    },
    description:
      "The dining room. The radio has been broadcasting fragments all evening. Now it's time to restore the signal. Fix the radio. Hear what it's been trying to say.",
    ...
    da: {
      title: "Spisestuen",
      description: "Spisestuen. Radioen har sendt fragmenter hele aftenen. Nu er det tid til at gendanne signalet.",
      lockedDescription: "Spisestuen. Udforsk resten af huset først.",
      atmosphere: "Et langt fyrretræsbord, otte stole. Stearinlys i lysestager. Og på hylden — radioen. Gammel brun bakelit, grøn tunerskive.",
    },
  },

  {
    ...
    unlockCost: 0,
    unlockRequires: ["living-room"],
    questIds: ["kitchen-act2-explore", "kitchen-act2-fragment"],
...

  {
    ...
    questIds: ["activity-room-fragment", "activity-room-social"],
